...
1) **Аналитика:**
   - Отчеты по бронированиям, среднему чеку, популярным временам;
   - Данные о клиентах (с согласия пользователей);
1) **Продвижение:**
...
   - Адаптация под культурные особенности разных регионов.